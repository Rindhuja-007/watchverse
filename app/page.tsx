      ...
      <div className="mx-auto max-w-7xl px-6 py-6 sm:px-10 lg:px-14">
        ...
        <section className="grid gap-12 py-20 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:py-28">
          ...
          <div className="relative mx-auto h-[390px] w-full max-w-[500px] sm:h-[470px]" aria-label="Featured titles">
            <div className="poster-card-hover absolute right-0 top-8 h-[320px] w-[210px] rotate-[9deg] overflow-hidden rounded-2xl bg-[#332a2d] shadow-2xl shadow-black/50 sm:h-[390px] sm:w-[255px]"><Image src="https://image.tmdb.org/t/p/w500/1pdfLvkbY9ohJlCjQH2CZjjYVvJ.jpg" alt="Dune: Part Two poster" fill sizes="(min-width: 640px) 255px, 210px" className="object-cover" priority /><div className="absolute inset-0 bg-gradient-to-t from-black/85 via-black/10 to-black/20" /><div className="relative flex h-full flex-col justify-between p-5"><span className="text-xs tracking-[0.3em] text-white/70">FEATURED</span><span className="text-5xl font-semibold tracking-[-0.08em] text-white">DUNE<small className="block text-sm tracking-[0.25em]">PART TWO</small></span></div></div>
            <div className="poster-card-hover absolute left-4 top-20 h-[320px] w-[210px] -rotate-[9deg] overflow-hidden rounded-2xl bg-[#263744] shadow-2xl shadow-black/50 sm:h-[390px] sm:w-[255px]"><Image src="https://image.tmdb.org/t/p/w500/k3waqVXSnvCZWfJYNtdamTgTtTA.jpg" alt="Past Lives poster" fill sizes="(min-width: 640px) 255px, 210px" className="object-cover" priority /><div className="absolute inset-0 bg-gradient-to-t from-black/85 via-black/10 to-black/20" /><div className="relative flex h-full flex-col justify-between p-5"><span className="text-xs tracking-[0.3em] text-white/70">YOUR NEXT WATCH</span><span className="text-5xl font-semibold tracking-[-0.08em] text-white">PAST<small className="block text-sm tracking-[0.25em]">LIVES</small></span></div></div>
